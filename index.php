...
if (!empty($_SESSION['active'])) {
  ...
  if (!empty($_POST)) {
    if (empty($_POST['usuario']) || empty($_POST['clave'])) {
      $alert = '<div id="alertMsg" class="alert alert-danger" role="alert">Ingrese su usuario y su clave</div>';
    } else {
      ...
      if ($resultado > 0) {
        ...
        $alert = '<div id="alertMsg" class="alert alert-danger" role="alert">Usuario o Contraseña Incorrecta</div>';
        session_destroy();
      }
    }
  }
          ...
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-6 d-none d-lg-block bg-login-image">
                <img src="./sistema/img/Refugio PNG.png" class="img-thumbnail border-0">
              </div>
              <div class="col-lg-6">
                <div class="p-5">
